...
public class ShortAnswerModificationStrategy implements QuestionModificationStrategy {
	...
	public void modifyQuestion(Scanner scanner, Question question) {
		...
		int maxPromptCharCount = ShortAnswerGenerator.getMaxPromptCharCount();

		System.out.println("Modifying Short Answer question");
		System.out.println("===========================================");
